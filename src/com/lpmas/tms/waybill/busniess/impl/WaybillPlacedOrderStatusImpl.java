...
public class WaybillPlacedOrderStatusImpl implements WaybillStatus {

	private WaybillInfoBean bean;

	public WaybillPlacedOrderStatusImpl(WaybillInfoBean bean) {
		this.bean = bean;
	}
	...
	public int receive() {
		...
		bean.setWaybillStatus(WaybillConfig.WAYBILL_STATUS_RECEIVED);
