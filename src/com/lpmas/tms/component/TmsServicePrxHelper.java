...
public final class TmsServicePrxHelper extends Ice.ObjectPrxHelperBase implements TmsServicePrx
{
    ...
    public Ice.AsyncResult begin_rpc(String method, String params, Callback_TmsService_rpc __cb)
    {
        return begin_rpc(method, params, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx, Callback_TmsService_rpc __cb)
    {
        return begin_rpc(method, params, __ctx, true, false, __cb);
    }
                         ...
                         new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                             {
                                 ...
                                 {
                                     TmsServicePrxHelper.__rpc_completed(this, __result);
                                 }
                             });
    }
    ...
    {
        com.lpmas.tms.component.TmsServicePrx __proxy = (com.lpmas.tms.component.TmsServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static TmsServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static TmsServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static TmsServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static TmsServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static TmsServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static TmsServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, TmsServicePrx.class, TmsServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::tms::component::TmsService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, TmsServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static TmsServicePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            TmsServicePrxHelper result = new TmsServicePrxHelper();
