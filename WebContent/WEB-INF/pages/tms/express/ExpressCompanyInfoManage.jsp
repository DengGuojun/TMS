...
<% 
ExpressCompanyInfoBean bean = (ExpressCompanyInfoBean)request.getAttribute("CompanyInfo");
...
<form id="formData" name="formData" method="post" action="ExpressCompanyInfoManage.do" onsubmit="javascript:return checkForm('formData');">
